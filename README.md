...
- <img src="ddia.webp" alt="Designing Data-Intensive Applications" height="25"> Experienced in building **data-intensive** **and AI-powered systems**, including **LLM applications, natural-language interfaces for structured data, document extraction pipelines, backend APIs, and analytical workflows**.

- <img src="microscope.svg" alt="" width="18" height="18"> **Research experience** spanning **Machine Learning, geospatial analysis, Large Language Models, Applied NLP, and Data Mining**.
...
- 🍃 [Breez🥉](https://biabcaval.github.io/space_apps_hackaton/) - A NASA Space Apps project focused on air quality and climate intelligence with location-based environmental insights.
- ⚖️ [equidar🥉](https://erlonL.github.io/equidar) - A social-impact project aimed at equity and inclusion themes.
